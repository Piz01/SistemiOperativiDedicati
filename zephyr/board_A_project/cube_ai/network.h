...
#define STAI_NETWORK_ORIGIN_MODEL_NAME         "yolov8t_lp_gray_split_perchannel_quant_calibration_data_192_bw_npz_1"
#define STAI_NETWORK_ORIGIN_MODEL_SIGNATURE    "0xd6c7bdbc8995fcf93fe86b3417f8ca81"

/*  Generated model name and signature  */
#define STAI_NETWORK_MODEL_NAME                "network"
#define STAI_NETWORK_MODEL_SIGNATURE           (0xb1513b606daa56ca)
...
#define STAI_NETWORK_IN_1_SHAPE       {1,1,192,192}
...
#define STAI_NETWORK_IN_1_SIZE        (36864)
#define STAI_NETWORK_IN_1_SIZE_BYTES  (36864)
...
#define STAI_NETWORK_OUT_SIZE_BYTES      (3784)
...
#define STAI_NETWORK_OUT_1_SHAPE       {1,4,756}
#define STAI_NETWORK_OUT_1_BATCH       (1)
#define STAI_NETWORK_OUT_1_CHANNEL     (4)
#define STAI_NETWORK_OUT_1_HEIGHT      (756)
#define STAI_NETWORK_OUT_1_RANK        (2)
#define STAI_NETWORK_OUT_1_SIZE        ((756 * 4))
#define STAI_NETWORK_OUT_1_SIZE_BYTES  (3024)
#define STAI_NETWORK_OUT_1_SCALE       (1.9618016481399536f)
#define STAI_NETWORK_OUT_1_ZERO_POINT  (-125)
...
#define STAI_NETWORK_OUT_2_SHAPE       {1,1,756}
#define STAI_NETWORK_OUT_2_BATCH       (1)
#define STAI_NETWORK_OUT_2_CHANNEL     (1)
#define STAI_NETWORK_OUT_2_HEIGHT      (756)
#define STAI_NETWORK_OUT_2_RANK        (2)
#define STAI_NETWORK_OUT_2_SIZE        ((756 * 1))
#define STAI_NETWORK_OUT_2_SIZE_BYTES  (756)
#define STAI_NETWORK_OUT_2_SCALE       (0.0031456942670047283f)
#define STAI_NETWORK_OUT_2_ZERO_POINT  (-128)

/*****************************************************************************/
/*  Macros to declare activations buffers characteristics  */
#define STAI_NETWORK_ACTIVATIONS_SIZE              (410112)
#define STAI_NETWORK_ACTIVATIONS_SIZE_BYTES        (410112)
...
#define STAI_NETWORK_ACTIVATION_1_SIZE       (410112)
#define STAI_NETWORK_ACTIVATION_1_SIZE_BYTES (410112)
...
#define STAI_NETWORK_WEIGHTS_SIZE                  (617296)
#define STAI_NETWORK_WEIGHTS_SIZE_BYTES            (617296)
...
#define STAI_NETWORK_WEIGHT_1_SIZE        (617296)
#define STAI_NETWORK_WEIGHT_1_SIZE_BYTES  (617296)
