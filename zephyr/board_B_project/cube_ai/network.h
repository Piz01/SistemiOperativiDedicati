...
#define STAI_NETWORK_ORIGIN_MODEL_NAME         "cct_xs_v1_global_perchannel_quant_random_1"
#define STAI_NETWORK_ORIGIN_MODEL_SIGNATURE    "0xe5ada796ea52fba27da170367b642ab3"

/*  Generated model name and signature  */
#define STAI_NETWORK_MODEL_NAME                "network"
#define STAI_NETWORK_MODEL_SIGNATURE           (0x3215e5425be49cbf)
...
#define STAI_NETWORK_IN_1_SHAPE       {1,64,128,3}
...
#define STAI_NETWORK_IN_1_SIZE        (24576)
#define STAI_NETWORK_IN_1_SIZE_BYTES  (24576)

/*****************************************************************************/
/*  Macros to declare output buffers characteristics  */
#define STAI_NETWORK_OUT_NUM             (1)
#define STAI_NETWORK_OUT_SIZE_BYTES      (340)
...
#define STAI_NETWORK_OUT_1_SHAPE       {1,9,37}
#define STAI_NETWORK_OUT_1_BATCH       (1)
#define STAI_NETWORK_OUT_1_CHANNEL     (9)
#define STAI_NETWORK_OUT_1_HEIGHT      (37)
#define STAI_NETWORK_OUT_1_RANK        (2)
#define STAI_NETWORK_OUT_1_SIZE        ((37 * 9))
#define STAI_NETWORK_OUT_1_SIZE_BYTES  (333)
#define STAI_NETWORK_OUT_1_SCALE       (0.003921568859368563f)
#define STAI_NETWORK_OUT_1_ZERO_POINT  (-128)

/*****************************************************************************/
/*  Macros to declare activations buffers characteristics  */
#define STAI_NETWORK_ACTIVATIONS_SIZE              (296212)
#define STAI_NETWORK_ACTIVATIONS_SIZE_BYTES        (296212)
...
#define STAI_NETWORK_ACTIVATION_1_SIZE       (296212)
#define STAI_NETWORK_ACTIVATION_1_SIZE_BYTES (296212)
...
#define STAI_NETWORK_WEIGHTS_SIZE                  (494424)
#define STAI_NETWORK_WEIGHTS_SIZE_BYTES            (494424)
...
#define STAI_NETWORK_WEIGHT_1_SIZE        (494424)
#define STAI_NETWORK_WEIGHT_1_SIZE_BYTES  (494424)
