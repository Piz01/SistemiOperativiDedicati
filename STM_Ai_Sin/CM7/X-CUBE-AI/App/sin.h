...
#include "sin_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_SIN_MODEL_NAME          "sin"
#define AI_SIN_ORIGIN_MODEL_NAME   "sin_model"

/******************************************************************************/
#define AI_SIN_ACTIVATIONS_ALIGNMENT   (4)
#define AI_SIN_INPUTS_IN_ACTIVATIONS   (4)
#define AI_SIN_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_SIN_IN_NUM        (1)

AI_DEPRECATED
#define AI_SIN_IN \
  ai_sin_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_SIN_IN_SIZE { \
  AI_SIN_IN_1_SIZE, \
}
#define AI_SIN_IN_SIZE_BYTES { \
  AI_SIN_IN_1_SIZE_BYTES, \
}
#define AI_SIN_IN_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_SIN_IN_1_CHANNEL     (1)
#define AI_SIN_IN_1_SIZE        (1)
#define AI_SIN_IN_1_SIZE_BYTES  (4)

/******************************************************************************/
#define AI_SIN_OUT_NUM       (1)

AI_DEPRECATED
#define AI_SIN_OUT \
  ai_sin_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_SIN_OUT_SIZE { \
  AI_SIN_OUT_1_SIZE, \
}
#define AI_SIN_OUT_SIZE_BYTES { \
  AI_SIN_OUT_1_SIZE_BYTES, \
}
#define AI_SIN_OUT_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_SIN_OUT_1_CHANNEL     (1)
#define AI_SIN_OUT_1_SIZE        (1)
#define AI_SIN_OUT_1_SIZE_BYTES  (4)

/******************************************************************************/
#define AI_SIN_N_NODES (5)
 ...
 * @ref ai_sin_create. Both the activations memory buffer 
 ...
 * header generated by the code generation tool. See AI_SIN_*
 * defines into file @ref sin.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
